...
public class BankManagement {
    ...
    // Create Account
    public static boolean createAccount(String name, String passCode) {
        ...
        try {
            ...
            String sql = "INSERT INTO customer(cname, balance, pass_code) VALUES (?, 5000, ?)";
    ...
    // Login Account
    public static boolean loginAccount(String name, String passCode) {
        if (name.isEmpty() || passCode.isEmpty()) {
            System.out.println("All fields are required!");
            return false;
        }
        ...
        try {
            ...
            if (rs.next()) {
                ...
                while (true) {
                    System.out.println("Hello, " + rs.getString("cname") + "! What would you like to do?");
